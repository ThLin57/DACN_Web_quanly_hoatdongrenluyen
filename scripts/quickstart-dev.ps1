# DACN Web Quản Lý Hoạt Động Rèn Luyện - Development Quick Start
# Script này khởi động toàn bộ hệ thống development với tất cả services cần thiết
...
Write-Host "🗄️  Database: localhost:5434 (PostgreSQL)" -ForegroundColor Cyan
