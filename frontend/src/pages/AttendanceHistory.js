...
export default function AttendanceHistory() {
  ...
  const loadAttendanceHistory = async () => {
    try {
      ...
      const response = await http.get('/student/attendance-history', { params: filter });
      ...
      React.createElement('main', { key: 'main', className: 'flex-1 p-6' }, [
        ...
        React.createElement('div', { key: 'filters', className: 'bg-white rounded-lg border p-4 mb-6' }, [
          ...
          React.createElement('div', { key: 'filter-grid', className: 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4' }, [
            React.createElement('div', { key: 'semester' }, [
              ...
              React.createElement('select', {
                ...
                React.createElement('option', { key: 'hk1', value: 'hoc_ky_1' }, 'Học kỳ I'),
                React.createElement('option', { key: 'hk2', value: 'hoc_ky_2' }, 'Học kỳ II')
              ])
            ]),
            React.createElement('div', { key: 'year' }, [
              React.createElement('label', { key: 'label', className: 'block text-sm font-medium text-gray-700 mb-1' }, 'Năm học'),
              React.createElement('select', {
                key: 'input',
