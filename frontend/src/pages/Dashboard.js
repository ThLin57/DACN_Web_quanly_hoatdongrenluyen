      ...
      React.createElement('div', { key: 'body', className: 'flex' }, [
        ...
        React.createElement('main', { key: 'main', className: 'flex-1 p-6' }, [
          React.createElement(Routes, { key: 'r' }, [
            React.createElement(Route, { key: 'root', path: '/', element: React.createElement(DashboardStudent) }),
            ...
            React.createElement(Route, { key: 'fallback', path: '*', element: React.createElement(DashboardStudent) })
          ])
        ])
      ])
    ]
