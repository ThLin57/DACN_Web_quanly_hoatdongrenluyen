...
const classService = {
  ...
  approveRegistration: async (registrationId) => {
    try {
      const response = await http.put(`/class/registrations/${registrationId}/approve`);
      return response.data;
    } catch (error) {
  ...
  rejectRegistration: async (registrationId, reason) => {
    try {
      const response = await http.put(`/class/registrations/${registrationId}/reject`, { reason });
      return response.data;
    } catch (error) {
