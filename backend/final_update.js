...
async function findAndUpdateActiveUser() {
  try {
    console.log('🔍 Tìm user 2021003 đang active...\n');
    
    // Tìm user với username 2021003 
    ...
    if (!user) {
      console.log('❌ Không tìm thấy user 2021003');
      return;
    }
    ...
    console.log('\n🔧 Cập nhật SinhVien với ID:', sinhVienId);
    ...
    console.log('\n🎉 HOÀN THÀNH! Bây giờ hãy test:');
    console.log('1. Đăng nhập với: 2021003 / Student@123');
    console.log('2. Truy cập: http://localhost:3000/profile/user');
    console.log('3. Kiểm tra 3 tab có đầy đủ thông tin');
